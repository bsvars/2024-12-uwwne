...
## <span style='color: #ff68b4;'>Część pierwsza</span> {background-color="#ededed"}

$$ $$

### Wielowymiarowe bayesowskie dynamiczne modele strukturalne z paczek bsvars i bsvarSIGNs dla R  {style="color:#ff68b4;"}
...
## <span style='color: #ff68b4;'>Część druga</span> {background-color="#ededed"}

$$ $$

### Analiza efektów australijskiej polityki monetarnej używając paczki bsvars  {style="color:#ff68b4;"}

$$ $$

#### Analiza efektów australijskiej polityki monetarnej {style="color:#ff68b4;"}

#### ustawienie i estymacja modelu {style="color:#ff68b4;"}

#### analizy strukturalne i predyktywne {style="color:#ff68b4;"}
...
### slajdy jako [strona internetowa](https://bsvars.org/2024-12-uek/) {style="color:#ff68b4;"}

### [repozytorium](https://github.com/bsvars/2024-12-uek) na GitHub dla reprodukcji wyników{style="color:#ff68b4;"}
...
- $\mathbf{B}$ <text style="color:#ededed;">**nie jest indentyfikowalna**</text>
...
plot(
  ...
  ylab = "", xlab = "x",
  axes = FALSE,
  main = "heteroskedastyczność i rozkład leptokurtyczny"
)
abline(a = 0, b = 1, col = "#ff68b4")
abline(a = 0, b = -1, col = "#ff68b4")
...
## <span style='color: #ff68b4;'>Australian Monetary Policy Analysis</span> {background-color="#ededed"}

$$ $$

[Download reproduction script](https://github.com/bsvars/2024-12-uek/blob/master/bsvars_oz.R)
